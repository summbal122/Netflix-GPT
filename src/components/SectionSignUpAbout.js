      ...
      <div className="space-y-4">
       ...
       <div className='flex flex-col space-y-2'>
        ...
        <div className='space-y-[2px] text-white'>
          <div className='bg-[#2d2d2d] py-3 px-5 flex items-center justify-between'>
            <p className='text-2xl '>What is Netflix?</p>
            <span  
            onClick={() => setOpenIndex(openIndex === 0 ? null : 0)}
            className='text-5xl font-thin'>{openIndex=== 0 ? '-' : '+'}</span>
           
          </div>
          {openIndex === 0 && (
             <div className='bg-[#2d2d2d] py-3 px-5 text-2xl space-y-8'>
        ...
        <div className='space-y-[2px] text-white'>
          <div className='bg-[#2d2d2d] py-3 px-5 flex items-center justify-between'>
            ...
            className='text-5xl font-thin'>{openIndex === 1 ? '-' : '+'}</span>
           
          </div>
          {openIndex === 1 && (
             <div className='bg-[#2d2d2d] py-3 px-5 text-2xl'>
        ...
        <div className='space-y-[2px] text-white'>
          <div className='bg-[#2d2d2d] py-3 px-5 flex items-center justify-between'>
            ...
            className='text-5xl font-thin'>{openIndex === 2 ? '-' : '+'}</span>
        ...
        <div className='space-y-[2px] text-white'>
          <div className='bg-[#2d2d2d] py-3 px-5 flex items-center justify-between'>
            ...
            className='text-5xl font-thin'>{openIndex=== 3 ? '-' : '+'}</span>
        ...
        <div className='space-y-[2px] text-white'>
          <div className='bg-[#2d2d2d] py-3 px-5 flex items-center justify-between'>
            ...
            className='text-5xl font-thin'>{openIndex===4 ? '-' : '+'}</span>
        ...
        <div className='space-y-[2px] text-white'>
          <div className='bg-[#2d2d2d] py-3 px-5 flex items-center justify-between'>
            ...
            className='text-5xl font-thin'>{openIndex===5 ? '-' : '+'}</span>
