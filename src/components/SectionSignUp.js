        ...
        <div className="flex flex-col w-9/12 gap-20 py-30 ">
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-2 md:gap-4 overflow-x-auto md:overflow-visible">
              <i className="fa-solid fa-chevron-left hidden md:block text-xl text-white/70 bg-[#2d2d2d] py-12 px-1 border border-none rounded-md"></i>
              <div className="flex gap-6 md:gap-12 overflow-x-auto no-scrollbar">
                {topMovies.map((img, index) => (
                  <div key={index} className="flex items-end min-w-[150px] sm:min-w-[160px] md:min-w-[180px]">
                    ...
                    <img
                      className="rounded-lg w-[120px] sm:w-[160px] md:w-[200px] h-auto"
              ...
              <i className="fa-solid fa-chevron-right hidden md:block text-xl text-white/70 bg-[#2d2d2d] py-12 px-1 border border-none rounded-md"></i>
            </div>
          </div>
          <SectionSignUpAbout />
        </div>
